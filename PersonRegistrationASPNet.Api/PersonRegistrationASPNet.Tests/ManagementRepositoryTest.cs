...
namespace PersonRegistrationASPNet.Tests
{
    public class ManagementRepositoryTest
    {
        ...
        [Theory, AutoData]
        public void ManagementRepository_ChangeUserHauseNumber_ReturnsDto_Returns_Correct_Message(int hauseNumber, Guid userId, User user)
        {
            var users = new List<User>();
            users.Add(user);
            var applicationDbContextMock = new Mock<ApplicationDbContext>();
            ...
            var response = sut.ChangeUserHauseNumber(hauseNumber, userId);
            var message = response.Message;
        ...
        [Theory, AutoData]
        public void ManagementRepository_ChangeUserHauseNumber_ReturnsDto_Returns_true(int hauseNumber, User user)
        {
            var users = new List<User>();
            users.Add(user);
            var applicationDbContextMock = new Mock<ApplicationDbContext>();
            ...
            var response = sut.ChangeUserHauseNumber(hauseNumber, user.Id);
            var isSuccess = response.IsSuccess;
